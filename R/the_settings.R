...
the$tracking_data_path <- '/work/pi_drsheldon_umass_edu/birdflow_modeling/dslager_umass_edu/tracking_data'
the$model_release_staging_path <- '/work/pi_drsheldon_umass_edu/birdflow_modeling/dslager_umass_edu/model_release_staging'
