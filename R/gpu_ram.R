...
#' @param max_param_per_gb The number of parameters that can be fit with each
#' GB of GPU ram. If `NULL`, the default the value from
#' `BirdFlowOptions()` is used. The only reason to set it here is if that value
