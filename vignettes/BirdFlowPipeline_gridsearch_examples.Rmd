---
title: "BirdFlowPipeline_gridsearch_examples"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{BirdFlowPipeline_gridsearch_examples}
...
# Fit, validate, and select BirdFlow models

This document is to illustrate the steps for training a batch of BirdFlow models, loading the validation transition data, calculating validation metrics for each models, and select the best models (model tuning).
...
sp_output_path <- glue::glue('~/birdflow_test/batch_model_validation/test_resolution_{resolution}km/{sp}')
