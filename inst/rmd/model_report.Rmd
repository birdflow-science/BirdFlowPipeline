...
grid_search_context_plot <- function(ll_df, row_chosen = 1){
...
grid_search_context_plot(ll_df, 1)
```
...
cal_pdf_dir <- file.path(params$output_path, 'pit_plots', sub('\\.hdf5$', '', ll_df$model[1]))
...
- desirability rank within grid search: `r 1`
